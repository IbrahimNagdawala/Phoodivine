...
function displayItems() {
  let chineese = document.getElementById("chineese");

  const chineeseData = foodItem.filter((item) => item.category == "chineese");
  console.log(chineeseData);
  chineeseData.map((item) => {
